...
# Lasso Regression using Mini Batch Gradient Descent

class LassoRegularization(RegressorMixin, BaseEstimator):
    """Mini-batch Gradient Descent implementation of Lasso Regression."""
...
custom_lasso = LassoRegularization(alpha=0.01)
...
print("Custom Lasso      :", custom_lasso.score(x_test, y_test))
print("Sklearn Lasso     :", sklearn_lasso.score(x_test, y_test))
